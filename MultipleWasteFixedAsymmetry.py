...
toolbox.register("evaluate", partial(dressCode.evaluateFixedAsymmetry, waste=waste))
...
svgHelper.save_polygons_to_svg(
    [waste[0], shirt_front, waste[1], shirt_back, waste[2], left_sleeve, waste[3], right_sleeve],
    "images/bestMultipleWasteFixedAsymmetry.svg")
